...
| 0078 | [An `ai` task is a first-class type executed as a pod from a Flow-shipped worker image](0078-an-ai-task-type-runs-a-flow-shipped-worker-as-a-pod.md) | accepted | 2026-09-16 |
