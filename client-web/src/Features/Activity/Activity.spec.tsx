...
// Route-module test pattern - see GlobalParameters.spec.tsx/WorkspaceTasks.spec.tsx. The
// header's workspace object (displayName/breadcrumb) comes from the harness's own
